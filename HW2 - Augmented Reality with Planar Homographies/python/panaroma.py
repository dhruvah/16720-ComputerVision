...
pano_left = cv2.imread('../ec/IMG-7531.jpg')
pano_right = cv2.imread('../ec/IMG-7530.jpg')
pano_left = cv2.resize(pano_left, (600, 450))
pano_right = cv2.resize(pano_right, (600, 450))
...
plt.imshow(panorama)    
cv2.imwrite('../result/panorama2.jpg', panorama)
plt.axis('off')